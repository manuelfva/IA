...
/// <summary>
/// Service implementation that checks whether the current Windows user is a member of a specific Active Directory group.
/// Uses LDAP to verify group membership against the dynamically discovered Domain Controller.
/// </summary>
public class UserGroupAuthorizationService : IUserGroupAuthorizationService
{
    ...
    /// </summary>
    /// <param name="discovery">The Active Directory discovery service.</param>
    /// <param name="logger">The logger instance.</param>
    /// <param name="settings">The authorization settings containing the required group name.</param>
